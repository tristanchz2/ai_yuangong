...
from config.settings import PROJECT_ROOT, SCRAPERS_DIR, RAW_DATA_DIR, LOGS_DIR, EXTRACT_SCRIPT
...
async def _count_extracted_records(source: str) -> int:
    ...
    try:
        ...
        from services.bid_repo import get_site_id_by_scraper_name
