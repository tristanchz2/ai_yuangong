...
SITES_DATA = [
    ...
    (18, '浦发银行', 'https://ebuy.spdb.com.cn/#/notice', 'spdb', '浦东发展银行', None, 'active', 0),
    (19, '恒丰银行', 'https://www.hfbank.com.cn/gyhf/cgpt/jzcg/ygg/index.shtml', 'hfbank', '', None, 'active', 0),
    (20, '北京银行集中采购管理系统', 'https://login-cpm-xt.bankofbeijing.com.cn/cms/default/webfile/1ywgg1/index.html', 'bankofbeijing', '北京银行', None, 'active', 0),
]
